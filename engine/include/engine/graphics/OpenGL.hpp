...
public:
    ...
    */
    ...
    /**
    * @brief Initializes the cube Vertex Array Object used for skyboxes drawing. Caches the vao result.
    * @returns VAO of the cube used for skyboxes drawing.
    */
    ...
    */
    ...
    /**
    * @brief Loads the skyboxes textures from the `path`.
